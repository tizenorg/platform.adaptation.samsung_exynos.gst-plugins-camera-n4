...
static int _camerasrc_dequeue_buffer(camerasrc_handle_t *handle, int *buf_index, camerasrc_buffer_t *buffer, camerasrc_buffer_t *thm_buffer)
{
	...
	camsrc_info("[3AA1 - CAPTURE] DQBUF index %d", buf_index_3aa1cap);
	...
	camsrc_info("[3AA1 - OUTPUT] DQBUF index %d", buf_index_3aa1out);
	...
	camsrc_info("[ISP] DQBUF index %d", buf_index_isp);
